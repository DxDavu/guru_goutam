...
const ClientSchema = new Schema(
  {
    client_id: { type: String, required: false, unique: true }, // Client ID
    client_name: { type: String, required: false }, // Client Name
    customer_type: { type: String, required: false }, // e.g., "IT Industry", "Supermarket"
    phone_number: { type: String, required: false }, // Client's Phone Number
