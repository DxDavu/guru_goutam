'use client';
import CreateStockLocationForm from '@/components/CreateStockLocationForm'; // Corrected import statement
...
const CreateProducts = () => {
  ...
  return (
   ...
   {!isFormOpen && (
    ...
    {isFormOpen && <CreateStockLocationForm onClose={() => setIsFormOpen(false)} />} {/* Corrected component usage */}
    ...
    {!isFormOpen && ( // Only render the table if isFormOpen is false
      <div className="mt-6">      <table className="w-full border-collapse border border-gray-300">
        <thead>
          <tr>
            <th className="border border-gray-300 p-2 bg-gray-300 text-center"> Stock Location  </th>
            <th className="border border-gray-300 p-2 bg-gray-300 text-center">Stock Name </th>
            <th className="border border-gray-300 p-2 bg-gray-300 text-center">Phone Number</th>
            <th className="border border-gray-300 p-2 bg-gray-300 text-center">Stock Location </th>
