'use client';
import CreateLibVarientForm from '@/components/CreateLibVarientForm'; // Corrected import statement
...
const CreateProducts = () => {
  ...
  return (
    ...
    {isFormOpen && <CreateLibVarientForm onClose={() => setIsFormOpen(false)} />} {/* Corrected component usage */}
    ...
    {!isFormOpen && ( // Only render the table if isFormOpen is false
      <div className="mt-6">      <table className="w-full border-collapse border border-gray-300">
        <thead>
          <tr>
            <th className="border border-gray-300 p-2 bg-gray-300 text-center">sL.NO    </th>
            <th className="border border-gray-300 p-2 bg-gray-300 text-center">Item Type   </th>
            <th className="border border-gray-300 p-2 bg-gray-300 text-center"> Item Specification Name  </th>
