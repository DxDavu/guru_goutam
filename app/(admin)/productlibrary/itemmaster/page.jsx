'use client';
import CreateLibMasterForm from '@/components/CreateLibMasterForm'; // Corrected import statement
...
const CreateProducts = () => {
  ...
  return (
   ...
   {!isFormOpen && (
    ...
    {isFormOpen && <CreateLibMasterForm onClose={() => setIsFormOpen(false)} />} {/* Corrected component usage */}
