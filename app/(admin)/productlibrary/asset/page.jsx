'use client';
import CreateAssetLibForm from '@/components/CreateAssetLibForm'; // Corrected import statement
...
const CreateProducts = () => {
  ...
  return (
    ...
    {isFormOpen && <CreateAssetLibForm onClose={() => setIsFormOpen(false)} />} {/* Corrected component usage */}
