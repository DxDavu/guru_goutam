'use client';
import CreateLibProductCategory from '@/components/CreateLibProductCategory'; // Corrected import statement
...
const CreateProducts = () => {
  ...
  return (
    ...
    {isFormOpen && <CreateLibProductCategory onClose={() => setIsFormOpen(false)} />} {/* Corrected component usage */}
