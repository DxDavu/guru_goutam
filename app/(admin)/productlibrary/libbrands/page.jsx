'use client';
import CreateLibraryBrandForm from '@/components/CreateLibraryBrandForm'; // Corrected import statement
...
const CreateProducts = () => {
  ...
  return (
    <div>
      {/* Only show the button if the form is not open */}
      {!isFormOpen && (
      ...
      {isFormOpen && <CreateLibraryBrandForm onClose={() => setIsFormOpen(false)} />} {/* Form is displayed here */}
      ...
      {!isFormOpen && ( // Only render the table if isFormOpen is false
        <div className="mt-6">
          <table className="w-full border-collapse border border-gray-300">
            <thead>
              <tr>
                <th className="border border-gray-300 p-2 bg-gray-300 text-center">Brand Code</th>
                <th className="border border-gray-300 p-2 bg-gray-300 text-center">Brand Name</th>
