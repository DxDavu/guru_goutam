  ...
  const grns = [
    {
      grnNumber: "123",
      dcNumber: "2839273",
      orderNumber: "PT/RQ/2012-13/1752-2",
      date: "12-07-2024",
    ...
    // Add more GRN objects as needed
  ];
          ...
          {grns.map((grn, index) => (
            <tr key={index} className="border border-gray-200">
              <td className="py-2 px-4 border border-gray-300">
                <input type="checkbox" className="toggle-checkbox" /> {grn.grnNumber}
              </td>
              <td className="py-2 px-4 border border-gray-300">{grn.dcNumber}</td>
              <td className="py-2 px-4 border border-gray-300">{grn.orderNumber}</td>
              <td className="py-2 px-4 border border-gray-300">{grn.date}</td>
              <td className="py-2 px-4 border border-gray-300">{grn.company}</td>
