    ...
    <div className="flex h-screen">
      ...
      <aside className="w-64 bg-gray-100 border-r">
        <nav className="flex flex-col py-4 space-y-4">
          ...
          <Link href="">
            <span
              className={`${linkClasses} ${activeTab === 'payment' ? activeLinkClasses : 'hover:bg-gray-200'}`}
          ...
          <Link href="/procurement/suppliers">
            <span
              className={`${linkClasses} ${activeTab === 'suppliers' ? activeLinkClasses : 'hover:bg-gray-200'}`}
