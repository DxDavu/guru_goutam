...
useEffect(() => {
  ...
  return (
    <form onSubmit={onSubmit} className="w-full max-w-screen-2xl mx-auto p-2 bg-white shadow-md rounded-lg mt-20">

      <div className=" bg-gray-200 p-2 md:p-2 border rounded-1g shadow-1g mb-6 flex  gap-9">
