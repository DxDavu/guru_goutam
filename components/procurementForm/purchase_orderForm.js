    ...
    <div className="bg-gray-50 p-6 border rounded-lg shadow-lg mb-6">
      ...
      <div className="flex flex-col md:flex-row gap-6">
        <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-4">
          {/* PR ID */}
          <div className="mb-4">
            <label htmlFor="po_id" className="text-sm font-medium">quottation ID</label>
            <Input
              id="po_id"
              type="number"
              {...register("po_id")}
          ...
          <div className="mb-4">
            <label htmlFor="po_quotation_id" className="text-sm font-medium">quottation ID</label>
            <Input
              id="po_quotation_id"
              type="number"
          ...
          {/* PR Date */}
          <div className="mb-4">
            <label htmlFor="po_date" className="text-sm font-medium">quotation Date</label>
            <Input
              id="po_date"
              type="date"
              {...register("po_date")}
          ...
          {/* po_owner */}
          <div>
            <label className="text-sm font-medium">po_owner</label>
          ...
          {/* Approve Status */}
          <div>
            <label className="text-sm font-medium"> total_cost</label>
            <Input
              type="number"
              {...register("total_cost")}
          ...
          <div>
            <label className="text-sm font-medium"> product_qty</label>
            <Input
              type="number"
