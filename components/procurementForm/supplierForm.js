    ...
    <form className="w-full max-w-1xl mx-auto p-8 bg-white shadow-md rounded-lg" onSubmit={onSubmit}>
      <div className="bg-gray-50 p-6 border rounded-lg shadow-lg mb-6">
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div>
            <label className="text-sm font-medium">emp_name</label>
          ...
          <div>
            <label className="text-sm font-medium"> emp_mobile </label>
            <Input
              type="number"
              {...register("emp_mobile")}
          ...
          {/* emp_office_num  */}
          <div>
            <label className="text-sm font-medium"> emp_office_num</label>
            <Input
              type="number"
