...
// import Image from "next/image";
// import { deleteInventory, getActiveProductCategories } from "@/actions/Inventory/inventoryActions";
...
//       try {
//         const fetchedCategories = await getActiveProductCategories();
...
//       header: "Categories",
//       cell: ({ row }) => {
//         const category = categories.find((cat) => cat.id === row.original.category);
//         return <p>{category ? category.category_name : "N/A"}</p>;
//       },
//     },
//     { accessorKey: "brand", header: "Brand" },
//     { accessorKey: "specifications", header: "Specifications" },
//     { accessorKey: "product_status", header: "Product Status" },
//     { accessorKey: "purchase_price", header: "Purchase Price" },
//     { accessorKey: "price_per_30days", header: "Price /30 days" },
//     {
//       accessorKey: "active_status",
//       header: "Active Status",
//       cell: ({ row }) => (row.original.active_status ? "Active" : "Inactive"),
...
//                 <div className="bg-white p-6 rounded-md max-w-sm mx-auto">
//                   <h3 className="text-lg font-medium">Delete Confirmation</h3>
//                   <p className="mt-2 text-sm">Are you sure you want to delete this inventory item?</p>
//                   <div className="flex justify-end gap-4 mt-4">
//                     <Button variant="outline" onClick={() => setIsDeleteConfirmOpen(false)}>
//                       Cancel
//                     </Button>
