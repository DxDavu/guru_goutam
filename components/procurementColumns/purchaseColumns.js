...
import { deletePurchase } from '@/actions/procuurement/purchaseActions';
deletePurchase
...
export const columns = [
  ...
  { accessorKey: "total_product_qty", header: "Total Product Quantity" },
  { accessorKey: "approve_status", header: "Approve Status" },
  { accessorKey: "move_to_next", header: "Move to Next" },
  {
