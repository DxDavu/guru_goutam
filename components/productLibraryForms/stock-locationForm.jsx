...
const StockLocationForm = ({ type, data }) => {
  ...
  return (
    <form className="w-full max-w-screen-2xl mx-auto p-6 sm:p-8 bg-white shadow-md rounded-lg" onSubmit={onSubmit}>
      <div className="flex flex-col lg:flex-row justify-between gap-8">

        {/* Stock Location Information Section */}
        <div className="bg-white p-4 sm:p-6 border rounded-lg shadow-lg w-full lg:w-1/3">
          <h3 className="text-base sm:text-lg font-semibold mb-4">Stock Location Information</h3>
          <div className="mb-4">
            <label className="text-xs sm:text-sm font-medium">Stock Location ID</label>
            <Input
              {...register("stock_location_id")}
          ...
          <div className="mb-4">
            <label className="text-xs sm:text-sm font-medium">Stock Name</label>
            <Input
              {...register("stock_name")}
          ...
          <label>Phone No</label>
            ...
            <Input {...register("phone_number")} placeholder=" contact_number " />
        ...
        <div className="bg-white p-4 sm:p-6 border rounded-lg shadow-lg w-full lg:w-1/3">
          <h3 className="text-base sm:text-lg font-semibold mb-4">Address Details</h3>
        ...
        <div className="bg-white p-4 sm:p-6 rounded-lg shadow-sm border border-gray-200 w-full lg:w-1/4 flex-shrink-0">
          <h3 className="text-base sm:text-lg font-semibold mb-4">Control</h3>
          <div className="flex items-center gap-2">
            <Checkbox
              checked={watch("active_status")}
              onCheckedChange={(checked) => setValue("active_status", checked)}
            />
            <label className="text-xs sm:text-sm font-medium">Active Status</label>
          </div>
        </div>
      </div>
      ...
      <div className="flex justify-end gap-4 mt-6">
        <Button
          variant="outline"
          onClick={() => router.push("/product-library/stock-location")}
